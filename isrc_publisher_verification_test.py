        ...
        if isinstance(response_data, dict):
            ...
            for key, value in response_data.items():
                if "isrc" in key.lower() and "QZ9H8" in str(value):
                    ...
                    self.log_test("ISRC Prefix in Business Identifiers", True, f"Found ISRC prefix QZ9H8 in {key}: {value}")
                    break
            ...
            for key, value in response_data.items():
                if "publisher" in key.lower() and "PA04UV" in str(value):
                    ...
                    self.log_test("Publisher Number in Business Identifiers", True, f"Found Publisher number PA04UV in {key}: {value}")
                    break
    ...
    def test_ddex_identifiers(self):
        ...
        if isinstance(response_data, dict):
            ...
            for key, value in response_data.items():
                if "isrc" in key.lower() and "QZ9H8" in str(value):
                    isrc_prefix_found = True
                    self.log_test("ISRC Prefix in DDEX Identifiers", True, f"Found ISRC prefix QZ9H8 in {key}: {value}")
                    break
            ...
            for key, value in response_data.items():
                if "publisher" in key.lower() and "PA04UV" in str(value):
                    publisher_number_found = True
                    self.log_test("Publisher Number in DDEX Identifiers", True, f"Found Publisher number PA04UV in {key}: {value}")
                    break
