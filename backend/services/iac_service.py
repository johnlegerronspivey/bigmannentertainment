...
_APP_ROOT = os.path.dirname(_BACKEND_ROOT)
INFRA_DIR = os.path.join(_APP_ROOT, "infra")
INFRA_TF_DIR = os.path.join(_APP_ROOT, "infra-terraform")
INFRA_CDK_DIR = os.path.join(_APP_ROOT, "infra-cdk")
LAMBDA_DIR = os.path.join(_APP_ROOT, "lambda")
GH_WORKFLOWS_DIR = os.path.join(_APP_ROOT, ".github", "workflows")
