...
class PayPalPaymentService:
    ...
    async def create_payment(
        ...
        try:
            ...
            if not return_url:
                return_url = "https://social-connect-148.preview.emergentagent.com/payment/success"
            if not cancel_url:
                cancel_url = "https://social-connect-148.preview.emergentagent.com/payment/cancel"
