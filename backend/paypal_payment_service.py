...
class PayPalPaymentService:
    ...
    async def create_payment(
        ...
        try:
            ...
            if not return_url:
                return_url = "https://uln-label-editor-1.preview.emergentagent.com/payment/success"
            if not cancel_url:
                cancel_url = "https://uln-label-editor-1.preview.emergentagent.com/payment/cancel"
