...
class LicensingService:
    ...
    def _calculate_platform_compensation(self, license_doc: Dict, usage_metrics: Dict, 
        ...
        return {
            ...
            "sync_royalties": sync_royalties,
            "artist_compensation": artist_compensation,
            "songwriter_compensation": songwriter_compensation,
            "publisher_compensation": publisher_compensation,
            "big_mann_commission": big_mann_commission,
