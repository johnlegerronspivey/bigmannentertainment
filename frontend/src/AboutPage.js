  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="bg-slate-800 py-20 border-t border-slate-700">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-100 mb-6">Technology & Innovation</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2">Advanced Distribution</h3>
              <p className="text-slate-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2">Comprehensive Analytics</h3>
              <p className="text-slate-300">
